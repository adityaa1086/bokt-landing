...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden"
      ...
      {/* Subtle green glow top-right behind buildings */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-24 sm:pt-28 pb-16 sm:pb-20" style={{ zIndex: 2 }}>
        <div className="grid lg:grid-cols-[1fr_1.1fr] gap-0 items-center min-h-[calc(100vh-140px)]">
          ...
          <div className="max-w-[500px]">
            ...
            {/* Mobile-only: mini buildings teaser */}
            <motion.div custom={0.5} variants={fade} initial="hidden" animate="visible"
              className="lg:hidden mt-10 relative rounded-2xl overflow-hidden"
              style={{ background: 'rgba(13,31,24,0.03)', border: '1px solid rgba(13,31,24,0.08)' }}>
              <img
                src="/buildings-transparent.png"
                alt="Your neighborhood"
                className="w-full select-none"
                style={{ maxHeight: 220, objectFit: 'contain', objectPosition: 'bottom' }}
                draggable={false}
              />
              ...
              <div className="absolute top-3 left-3 flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg"
                ...
                <p className="text-[10px] font-heading font-bold" style={{ color: '#F4F0E8' }}>#1 Map Pack</p>
              </div>
              <div className="absolute top-3 right-3 flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg border border-bdr"
                style={{ background: 'rgba(244,240,232,0.95)' }}>
                <span className="w-1.5 h-1.5 rounded-full bg-accent animate-pulse" />
                <p className="text-[10px] font-heading font-semibold text-ink">47 calls answered</p>
              </div>
            </motion.div>
          </div>

          {/* ── Right: transparent buildings ── */}
          <div className="relative hidden lg:flex items-center justify-end">

            {/* The building — transparent PNG, bleed to right edge */}
            <motion.img
              src="/buildings-transparent.png"
              alt="Your local neighborhood"
            ...
            {/* Floating: Map Pack badge — sits over the storefronts */}
            <motion.div
              ...
              className="absolute left-4 bottom-[22%] flex items-center gap-2 px-3.5 py-2.5 rounded-xl"
              style={{
                background: '#0D1F18',
            ...
            <motion.div
              ...
              className="absolute right-[8%] top-[28%] flex items-center gap-2 px-3 py-2 rounded-xl border border-bdr"
              style={{ background: 'rgba(244,240,232,0.95)', backdropFilter: 'blur(12px)', boxShadow: '0 4px 20px rgba(13,31,24,0.08)' }}>
              <span className="w-1.5 h-1.5 rounded-full bg-accent animate-pulse shrink-0" />
            ...
            <motion.div
              ...
              className="absolute left-[12%] top-[18%] px-3 py-2 rounded-xl border border-bdr"
              style={{ background: 'rgba(244,240,232,0.95)', backdropFilter: 'blur(12px)', boxShadow: '0 4px 20px rgba(13,31,24,0.08)' }}>
            ...
            <motion.div
              ...
              className="absolute right-[14%] bottom-[32%] flex items-center gap-2 px-3 py-2 rounded-xl"
              style={{ background: '#0D1F18', boxShadow: '0 4px 20px rgba(13,31,24,0.3)' }}>
            ...
            {/* Floating: payment received pulse */}
            <motion.div
              ...
              className="absolute left-[6%] bottom-[38%] flex items-center gap-2 px-3 py-2 rounded-xl border"
              style={{ background: 'rgba(244,240,232,0.95)', borderColor: 'rgba(13,92,58,0.2)', boxShadow: '0 4px 20px rgba(13,31,24,0.08)' }}>
